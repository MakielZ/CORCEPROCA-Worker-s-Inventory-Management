        ...
        <div class="sidebar-panel">
                <div class="sidebar-header">
                    <div class="container align-content-lg-center">
                        <span class="titles">bienvenido</span>
                    </div>
                </div>
            </div>
            ...
            <ul class="list-unstyled components">
                ...
                <li>
                    ...
                    <ul class="collapse list-unstyled" id="homeSubmenu">
                        <li>
                            <a href="<?php RUTA_URL?>gestionProductoC">Agregar producto</a>
                        </li>
                        <li>
                            <a href="<?php RUTA_URL?>consultaProductoC">Consultar últimos productos agregados</a>
                        </li>
                        <li>
                            <a href="<?php RUTA_URL?>gestionItemC">Gestionar catálogo</a>
                        </li> 
                        <li>
                            <a href="<?php RUTA_URL?>consultaItemC">Consultar catálogo</a>
                        </li> 
